...
Ultrasonic strafeUS;
Ultrasonic directionUS;

//the input and output ports for the strafe ultrasonic sensor
#define ST_1_O 2
#define ST_2_I 1

//the input and output ports for the direction ultrasonic sensor.(forward and backward)
#define DI_1_O 4
#define DI_2_I 3

//the motor defines for the directional motors.
#define DIR_R_MOT 1
#define DIR_L_MOT 2
//the motor defines for the strafe motors.
#define STR_BACK_MOT 10
#define STR_FRONT_MOT 9
